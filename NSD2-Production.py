...
traj_folder = 'NSD2-{}-complex'.format(peptide)        # name of folder, where trajectories will be stored
...
ligand_xml_files = ['SAM.xml', 'ZNB.xml']   # list of ligand parameter xml files
ligand_pdb_files = ['SAM.pdb', 'ZNB.pdb']   # list of ligand pdb files
...
protonation_dict = {('A',1016): 'CYX', ('A',1018): 'CYX', ('A',1026):'CYX', ('A',1032): 'CYX', ('A',1041): 'CYX', ('A',1046):'CYX', ('A',1052):'CYX', ('A',1145):'CYX', ('A',1192):'CYX', ('A',1194):'CYX', ('A',1199):'CYX', ('B',36):'LYN'} #only for manual protonation
