...
number_replicates = 100 # number of replicates to analyze
...
for i in range(number_replicates):
    folder = '/path_to_trajectory/trajectory_replicate_{}'.format(i+1)
    print(folder)
